...
# Generate a key for encryption (use a fixed key for development to avoid data loss on restart)
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # Add corsheaders to apps
    'users',
    'ai_calls',
    'ai_emails',
    'appointments',
...
# Sentry for error tracking (commented out for now)
# import sentry_sdk
